...
public sealed class SqlHelper
	...
	public static string _connection = ConfigurationManager.ConnectionStrings["conn"].ConnectionString;
	...
	private SqlHelper() {}
		...
		public static int ExecuteNonQuery(CommandType commandType, string commandText)
		{
			...
			return ExecuteNonQuery(_connection, commandType, commandText, (SqlParameter[])null);
		}
    ...
    public static DataTable ExecuteTextDataTable(CommandType commandType, string commandText)
    {
        // Pass through the call providing null for the set of SqlParameters
        DataSet ds = ExecuteDataset(_connection,commandType, commandText);
